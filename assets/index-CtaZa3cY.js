 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vp;function H_(){return vp||(vp=1,function(s){function e(z,ae){var re=z.length;z.push(ae);e:for(;0<re;){var U=re-1>>>1,ne=z[U];if(0<a(ne,ae))z[U]=ae,z[re]=ne,re=U;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var ae=z[0],re=z.pop();if(re!==ae){z[0]=re;e:for(var U=0,ne=z.length,Ue=ne>>>1;U<Ue;){var Q=2*(U+1)-1,he=z[Q],Ee=Q+1,ve=z[Ee];if(0>a(he,re))Ee<ne&&0>a(ve,he)?(z[U]=ve,z[Ee]=re,U=Ee):(z[U]=he,z[Q]=re,U=Q);else if(Ee<ne&&0>a(ve,re))z[U]=ve,z[Ee]=re,U=Ee;else break e}}return ae}function a(z,ae){var re=z.sortIndex-ae.sortIndex;return re!==0?re:z.id-ae.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var f=Date,d=f.now();s.unstable_now=function(){return f.now()-d}}var p=[],m=[],_=1,v=null,x=3,S=!1,T=!1,R=!1,y=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,I=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(z){for(var ae=n(m);ae!==null;){if(ae.callback===null)r(m);else if(ae.startTime<=z)r(m),ae.sortIndex=ae.expirationTime,e(p,ae);else break;ae=n(m)}}function C(z){if(R=!1,L(z),!T)if(n(p)!==null)T=!0,se(V);else{var ae=n(m);ae!==null&&le(C,ae.startTime-z)}}function V(z,ae){T=!1,R&&(R=!1,g(Y),Y=-1),S=!0;var re=x;try{for(L(ae),v=n(p);v!==null&&(!(v.expirationTime>ae)||z&&!B());){var U=v.callback;if(typeof U=="function"){v.callback=null,x=v.priorityLevel;var ne=U(v.expirationTime<=ae);ae=s.unstable_now(),typeof ne=="function"?v.callback=ne:v===n(p)&&r(p),L(ae)}else r(p);v=n(p)}if(v!==null)var Ue=!0;else{var Q=n(m);Q!==null&&le(C,Q.startTime-ae),Ue=!1}return Ue}finally{v=null,x=re,S=!1}}var k=!1,N=null,Y=-1,P=5,A=-1;function B(){return!(s.unstable_now()-A<P)}function oe(){if(N!==null){var z=s.unstable_now();A=z;var ae=!0;try{ae=N(!0,z)}finally{ae?te():(k=!1,N=null)}}else k=!1}var te;if(typeof I=="function")te=function(){I(oe)};else if(typeof MessageChannel<"u"){var ce=new MessageChannel,pe=ce.port2;ce.port1.onmessage=oe,te=function(){pe.postMessage(null)}}else te=function(){y(oe,0)};function se(z){N=z,k||(k=!0,te())}function le(z,ae){Y=y(function(){z(s.unstable_now())},ae)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(z){z.callback=null},s.unstable_continueExecution=function(){T||S||(T=!0,se(V))},s.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<z?Math.floor(1e3/z):5},s.unstable_getCurrentPriorityLevel=function(){return x},s.unstable_getFirstCallbackNode=function(){return n(p)},s.unstable_next=function(z){switch(x){case 1:case 2:case 3:var ae=3;break;default:ae=x}var re=x;x=ae;try{return z()}finally{x=re}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(z,ae){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var re=x;x=z;try{return ae()}finally{x=re}},s.unstable_scheduleCallback=function(z,ae,re){var U=s.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?U+re:U):re=U,z){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=re+ne,z={id:_++,callback:ae,priorityLevel:z,startTime:re,expirationTime:ne,sortIndex:-1},re>U?(z.sortIndex=re,e(m,z),n(p)===null&&z===n(m)&&(R?(g(Y),Y=-1):R=!0,le(C,re-U))):(z.sortIndex=ne,e(p,z),T||S||(T=!0,se(V))),z},s.unstable_shouldYield=B,s.unstable_wrapCallback=function(z){var ae=x;return function(){var re=x;x=ae;try{return z.apply(this,arguments)}finally{x=re}}}}(pc)),pc}var xp;function V_(){return xp||(xp=1,hc.exports=H_()),hc.exports}/**
 * @license React
...
`)+`
`+g);const L=I+y+f,C=I+g+d,V=fm(a,a.VERTEX_SHADER,L),k=fm(a,a.FRAGMENT_SHADER,C);a.attachShader(R,V),a.attachShader(R,k),n.index0AttributeName!==void 0?a.bindAttribLocation(R,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(R,0,"position"),a.linkProgram(R);function N(B){if(s.debug.checkShaderErrors){const oe=a.getProgramInfoLog(R).trim(),te=a.getShaderInfoLog(V).trim(),ce=a.getShaderInfoLog(k).trim();let pe=!0,se=!0;if(a.getProgramParameter(R,a.LINK_STATUS)===!1)if(pe=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,R,V,k);else{const le=hm(a,V,"vertex"),z=hm(a,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(R,a.VALIDATE_STATUS)+`
...
`,Mm=75,Tm=400,wM=3,AM=80,wm=.01,RM=.95,CM=36,PM=()=>{const s=Xc.useRef(null);return Xc.useEffect(()=>{if(!s.current)return;const e=s.current,n=e.clientWidth||window.innerWidth,r=e.clientHeight||window.innerHeight,a=new d0,u=new Qm(-1,1,1,-1,0,1),f=new Kn(Mm,n/r,.1,1e3);f.position.set(0,.05,20),f.lookAt(0,0,0);const d=new aM({antialias:!0});d.setPixelRatio(Math.min(window.devicePixelRatio,2)),d.setSize(n,r);const p=new ut;d.getDrawingBufferSize(p),e.appendChild(d.domElement);const m=new uM(f,d.domElement);m.target.set(0,0,0),m.enableDamping=!0,m.dampingFactor=.08,m.enablePan=!1,m.autoRotate=!0,m.autoRotateSpeed=RM,m.minDistance=wM,m.maxDistance=AM,m.minPolarAngle=wm,m.maxPolarAngle=Math.PI-wm,m.update();const _=()=>{const V=document.createElement("canvas");V.width=1024,V.height=1024;const k=V.getContext("2d");if(!k)return null;const N=k.createRadialGradient(512,512,0,512,512,512);N.addColorStop(0,"#001a33"),N.addColorStop(1,"#000000"),k.fillStyle=N,k.fillRect(0,0,1024,1024),k.fillStyle="white";for(let Y=0;Y<200;Y+=1){const P=Math.random()*1024,A=Math.random()*1024,B=Math.random()*2+.5;k.globalAlpha=Math.random()*.8+.2,k.beginPath(),k.arc(P,A,B,0,Math.PI*2),k.fill()}return k.globalAlpha=1,new m0(V)},v=new S0;let x=null;const S=v.load(EM,V=>{T.uniforms.uCanvasTexture.value=V},void 0,()=>{x=_(),x&&(T.uniforms.uCanvasTexture.value=x)}),T=new Hi({uniforms:{uAccretionDisk:{value:1},uResolution:{value:p.clone()},uCanvasTexture:{value:S},uMaxIterations:{value:Tm},uPov:{value:Mm},uStepSize:{value:2.5/Tm},uCameraPosition:{value:f.position.clone()},uCameraForward:{value:new Z(0,0,-1)},uCameraRight:{value:new Z(1,0,0)},uCameraUp:{value:new Z(0,1,0)},uDiskTime:{value:0}},vertexShader:TM,fragmentShader:MM}),R=new gi(new Vo(2,2),T);a.add(R);const y=()=>{f.updateMatrixWorld(),f.getWorldDirection(T.uniforms.uCameraForward.value);const V=f.matrixWorld.elements;T.uniforms.uCameraPosition.value.copy(f.position),T.uniforms.uCameraRight.value.set(V[0],V[1],V[2]).normalize(),T.uniforms.uCameraUp.value.set(V[4],V[5],V[6]).normalize()},g=new M0;let I=0;const L=()=>{m.update(),y(),T.uniforms.uDiskTime.value=g.getElapsedTime()*CM,d.render(a,u),I=requestAnimationFrame(L)},C=()=>{const V=e.clientWidth||window.innerWidth,k=e.clientHeight||window.innerHeight;f.aspect=V/k,f.updateProjectionMatrix(),d.setSize(V,k),d.getDrawingBufferSize(T.uniforms.uResolution.value)};return window.addEventListener("resize",C),L(),()=>{cancelAnimationFrame(I),window.removeEventListener("resize",C),m.dispose(),R.geometry.dispose(),T.dispose(),S.dispose(),x==null||x.dispose(),d.dispose(),e.contains(d.domElement)&&e.removeChild(d.domElement)}},[]),Lo.jsx("div",{ref:s,className:"simulation-canvas"})};function bM(){return Lo.jsx("div",{className:"App",children:Lo.jsx(PM,{})})}j_.createRoot(document.getElementById("root")).render(Lo.jsx(B_.StrictMode,{children:Lo.jsx(bM,{})}));
